    ...
    <div class="topbuttons">
      ...
      <button id="corporate" type="button" class="btn btn-primary btn-sm">Corporate</button>
              ...
              <label id="register-name" for="inputPassword5" class="form-label">Title</label>
                ...
                <input id="register-input" type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" placeholder="First and last name">
                </div>
  ...
  <div id="register-input" class="form-group">
    ...
    <input type="text" class="form-control" aria-describedby="passwordHelpBlock" placeholder="Phone number">
  </div>
  ...
  <!--Email address  -->
   <div id="register-input" class="form-group">
    <label id="register-name" class="form-label">Email address</label>
      ...
      <input type="text" class="form-control" aria-describedby="passwordHelpBlock" placeholder="Email address">
